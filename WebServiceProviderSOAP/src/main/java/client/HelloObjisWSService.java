 ...
 * 
 */
@WebServiceClient(name = "HelloObjisWSService", targetNamespace = "http://SERVICE.ensup.eu/", wsdlLocation = "http://localhost:8091/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOOBJISWSSERVICE_QNAME = new QName("http://SERVICE.ensup.eu/", "HelloObjisWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8091/hello?wsdl");
    ...
    public HelloObjis getHelloObjisWSPort() {
        return super.getPort(new QName("http://SERVICE.ensup.eu/", "HelloObjisWSPort"), HelloObjis.class);
    }
    ...
    public HelloObjis getHelloObjisWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://SERVICE.ensup.eu/", "HelloObjisWSPort"), HelloObjis.class, features);
    }
