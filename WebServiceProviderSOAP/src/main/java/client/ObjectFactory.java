...
public class ObjectFactory {
    ...
    private final static QName _BonjourResponse_QNAME = new QName("http://SERVICE.ensup.eu/", "bonjourResponse");
    private final static QName _Bonjour_QNAME = new QName("http://SERVICE.ensup.eu/", "bonjour");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SERVICE.ensup.eu/", name = "bonjourResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SERVICE.ensup.eu/", name = "bonjour")
